...
void login()
{
    ...
    Password[i] = '\0';
    if(strcmp(UserName,"Bharath")==0 && strcmp(Password,"4444")==0)
    {
        system("cls");
        loginFrame1();
        gotoXY(27,10);
...
void intro()
{
    ...
    gotoXY(20,11); printf("Bharath Simha Reddy Mandadi");
    gotoXY(20,13); printf("https://github.com/Bharath4444");
    gotoXY(20,15); printf("https://www.linkedin.com/in/bharath-mandadi/");
